...
@section('title', 'Tambah Kategori - Lapor IT')
        ...
        <div class="bg-gradient-to-r from-blue-500 to-cyan-400 rounded-2xl p-6 shadow-lg text-white">
            <div class="flex items-center gap-3">
                <div>
                    ...
                    <p class="text-blue-50">Lapor IT - Buat Kategori Tiket Problem Solving IT</p>
                </div>
            </div>
        </div>
            ...
            <form method="POST" action="{{ route('categories.store') }}" class="space-y-5">
                ...
                <div>
                    ...
                    <textarea id="deskripsi" name="deskripsi" placeholder="Deskripsi singkat tentang kategori ini..."
                        class="w-full min-h-[120px] px-4 py-2.5 text-sm rounded-xl border-2 border-blue-200 resize-y focus:outline-none focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition">{{ old('deskripsi') }}</textarea>
