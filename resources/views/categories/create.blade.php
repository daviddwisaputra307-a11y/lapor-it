            ...
            <form method="POST" action="{{ route('categories.store') }}">
                ...
                <div class="mb-4">
                    ...
                    <textarea id="deskripsi" name="deskripsi" placeholder="Deskripsi singkat tentang kategori ini..."
                        class="w-full min-h-[100px] px-3 py-2 text-sm rounded-lg border border-slate-300 resize-y focus:outline-none focus:ring-4 focus:ring-blue-100 focus:border-blue-600">{{ old('deskripsi') }}</textarea>
