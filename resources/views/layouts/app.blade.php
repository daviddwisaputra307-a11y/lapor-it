        ...
        <div class="flex-1 flex flex-col">
            ...
            <div class="h-14 bg-white border-b flex items-center justify-end px-6">
                <a href="{{ route('admin.tickets.index') }}" class="relative">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-slate-600 hover:text-blue-600"
                    ...
                    @if ($notifCount ?? 0 > 0)
                        <span
                            class="absolute -top-1 -right-1 bg-red-600 text-white text-[10px] w-5 h-5 flex items-center justify-center rounded-full">
                            {{ $notifCount }}
                        </span>
                    @endif
                </a>
